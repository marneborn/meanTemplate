...
//                   },
        ...
        let concatIdx  = 0,
            annOffset  = buildConfig.ann.indexOf('concat*'),
            distOffset = buildConfig.dist.indexOf('concat*');
        ...
        for (let i=0; i<serverConfig.subApps.list.length; i++) {
            ...
            buildConfig.ann.splice (concatIdx+annOffset , 0, 'concat:concat'+concatIdx);
            buildConfig.dist.splice(concatIdx+distOffset, 0, 'concat:concat'+concatIdx);
            concatIdx++;
        ...
        buildConfig.ann .splice(concatIdx+annOffset , 1);
        buildConfig.dist.splice(concatIdx+distOffset, 1);
